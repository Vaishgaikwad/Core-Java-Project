...
public class Destinations extends JFrame implements Runnable {
    ...
    JLabel caption;
    public void run(){
        String[] text = new String[]{"JW Marrirot Hotel","Madrid Oriented Hotel","Four Seasons Hotel","Reddison Blue Hotel","Classio Hotel","The Bay Club Hotel","Breeze Blow Hotel","The Taj Hotel","Happy Morning Motel","River View Hotel"};
